// === The Optics & Waves · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('hs-optics-waves-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('hs-optics-waves-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
